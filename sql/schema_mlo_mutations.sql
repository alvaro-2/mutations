...
CREATE TABLE IF NOT EXISTS `mlo_mutations`.`disease` (
  ...
  `id_omim` VARCHAR(45) NULL,
  `id_medgen` VARCHAR(45) NULL,
  `id_mesh` VARCHAR(45) NULL,
  `id_mondo` VARCHAR(45) NULL,
  `id_orphanet` VARCHAR(45) NULL,
  `id_efo` VARCHAR(45) NULL,
...
-- -----------------------------------------------------
-- Table `mlo_mutations`.`human_phenotype_ontology`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mlo_mutations`.`human_phenotype_ontology` ;

CREATE TABLE IF NOT EXISTS `mlo_mutations`.`human_phenotype_ontology` (
  `id_hpo` VARCHAR(45) NOT NULL,
  PRIMARY KEY (`id_hpo`))
ENGINE = InnoDB;


-- -----------------------------------------------------
-- Table `mlo_mutations`.`disease_has_human_phenotype_ontology`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mlo_mutations`.`disease_has_human_phenotype_ontology` ;

CREATE TABLE IF NOT EXISTS `mlo_mutations`.`disease_has_human_phenotype_ontology` (
  `id_disease` INT NOT NULL,
  `id_hpo` VARCHAR(45) NOT NULL,
  PRIMARY KEY (`id_disease`, `id_hpo`),
  INDEX `fk_disease_has_human_phenotype_ontology_human_phenotype_ont_idx` (`id_hpo` ASC) VISIBLE,
  INDEX `fk_disease_has_human_phenotype_ontology_disease_idx` (`id_disease` ASC) VISIBLE,
  CONSTRAINT `fk_disease_has_human_phenotype_ontology_disease`
    FOREIGN KEY (`id_disease`)
    REFERENCES `mlo_mutations`.`disease` (`id_disease`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_disease_has_human_phenotype_ontology_human_phenotype_ontol`
    FOREIGN KEY (`id_hpo`)
    REFERENCES `mlo_mutations`.`human_phenotype_ontology` (`id_hpo`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
