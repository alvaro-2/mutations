...
CREATE TABLE IF NOT EXISTS `mlo_mutations`.`disease` (
  ...
  PRIMARY KEY (`cui`),
  UNIQUE INDEX `name_UNIQUE` (`disease_name` ASC) VISIBLE)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `mlo_mutations`.`cross_reference` (
  ...
  `cross_name` VARCHAR(45) NOT NULL,
  PRIMARY KEY (`id_cross`),
  UNIQUE INDEX `name_UNIQUE` (`cross_name` ASC) VISIBLE)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `mlo_mutations`.`mutation_has_disease` (
  `id_mutation` INT NOT NULL,
  `cui` VARCHAR(15) NOT NULL,
  PRIMARY KEY (`id_mutation`, `cui`),
  INDEX `fk_mutation_has_disease_disease_idx` (`cui` ASC) VISIBLE,
  ...
  CONSTRAINT `fk_mutation_has_disease_disease`
    FOREIGN KEY (`cui`)
    REFERENCES `mlo_mutations`.`disease` (`cui`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `mlo_mutations`.`disease_has_synonyms`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mlo_mutations`.`disease_has_synonyms` ;

CREATE TABLE IF NOT EXISTS `mlo_mutations`.`disease_has_synonyms` (
  `cui` VARCHAR(15) NOT NULL,
  `id_cross` INT NOT NULL,
  `name` VARCHAR(150) NULL,
  `code` VARCHAR(20) NOT NULL,
  PRIMARY KEY (`cui`, `id_cross`, `code`),
  INDEX `fk_disease_has_cross_reference_cross_reference_idx` (`id_cross` ASC) INVISIBLE,
  INDEX `fk_disease_has_cross_reference_disease_idx` (`cui` ASC) VISIBLE,
